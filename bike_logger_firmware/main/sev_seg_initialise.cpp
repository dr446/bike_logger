...
void sev_seg_set(int speed, int calories){
  ...
  mcp1.writeGPIO(segment_code((num_top/100) % 10));
  mcp3.writeGPIO(segment_code((num_bot/100)%10));
  delay(5);
  mcp1.writeGPIO(segment_code(10));
  mcp3.writeGPIO(segment_code(10));
  mcp2.writeGPIO(digit_code(0));
  mcp1.writeGPIO(segment_code((num_top/1000)%10));
  mcp3.writeGPIO(segment_code((num_bot/1000)%10));
  delay(5);
}
